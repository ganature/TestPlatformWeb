...
INSTALLED_APPS = ['django.contrib.admin', 'django.contrib.auth', 'django.contrib.contenttypes',
    'django.contrib.sessions', 'django.contrib.messages', 'django.contrib.staticfiles', 'apps.users', 'apps.env_config',
    'apps.project', 'apps.test_case', 'apps.test_plan', 'apps.test_report', 'apps.test_suite', 'apps.keywords',
    'xadmin', 'crispy_forms', 'reversion', 'rest_framework']
